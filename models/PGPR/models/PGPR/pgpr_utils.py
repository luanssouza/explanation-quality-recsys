...
DATASET_DIR = {
    ...
    ML100K: f'{ROOT_DIR}/data/{ML100K}/preprocessed/{MODEL}',
...
RECOM_METRICS_FILE_PATH = {
    ML100K: f'{CFG_DIR[ML100K]}/{RECOM_METRICS_FILE_NAME}',
...
TEST_METRICS_FILE_PATH = {
    ML100K: f'{CFG_DIR[ML100K]}/{TEST_METRICS_FILE_NAME}',
...
BEST_TEST_METRICS_FILE_PATH = {
    ML100K: f'{BEST_CFG_DIR[ML100K]}/{TEST_METRICS_FILE_NAME}',
...
TMP_DIR = {
    ...
    ML100K: f'{DATASET_DIR[ML100K]}/tmp',
}

# Label files.
LABELS = {
    ML100K: (TMP_DIR[ML100K] + '/train_label.pkl', TMP_DIR[ML100K] + '/valid_label.pkl', TMP_DIR[ML100K] + '/test_label.pkl'),
...
WROTE_BY_WRITTER = 'wrote_by_writer'
...
KG_RELATION = {
    ML100K: {
        ...
        DISTRIBUTOR: {
            DISTRIBUTED_BY_DISTRIBUTOR: PRODUCT,
        },
        PRODUCER: {
...
PATH_PATTERN = {
    ML100K: {
        0: ((None, USER), (INTERACTION[ML100K], PRODUCT), (INTERACTION[ML100K], USER), (INTERACTION[ML100K], PRODUCT)),
        2: ((None, USER), (INTERACTION[ML100K], PRODUCT), (CINEMATOGRAPHY_BY_CINEMATOGRAPHER, CINEMATOGRAPHER), (CINEMATOGRAPHY_BY_CINEMATOGRAPHER, PRODUCT)),
        3: ((None, USER), (INTERACTION[ML100K], PRODUCT), (BELONG_TO_CATEGORY, CATEGORY), (BELONG_TO_CATEGORY, PRODUCT)),
        4: ((None, USER), (INTERACTION[ML100K], PRODUCT), (STARRED_BY_ACTOR, ACTOR), (STARRED_BY_ACTOR, PRODUCT)),
        5: ((None, USER), (INTERACTION[ML100K], PRODUCT), (PRODUCED_BY_PRODUCER, PRODUCER), (PRODUCED_BY_PRODUCER, PRODUCT)),
        6: ((None, USER), (INTERACTION[ML100K], PRODUCT), (WROTE_BY_WRITTER, WRITTER), (WROTE_BY_WRITTER, PRODUCT)),
        7: ((None, USER), (INTERACTION[ML100K], PRODUCT), (DIRECTED_BY_DIRECTOR, DIRECTOR), (DIRECTED_BY_DIRECTOR, PRODUCT)),
    },
    ML1M: {
...
MAIN_PRODUCT_INTERACTION = {
    ML100K: (PRODUCT, INTERACTION[ML100K]),
