...
TRANSE_TEST_METRICS_FILE_PATH = {
    ML100K: f'{CFG_DIR[ML100K]}/{TRANSE_TEST_METRICS_FILE_NAME}',
...
BEST_TRANSE_TEST_METRICS_FILE_PATH = {
    ML100K: f'{BEST_CFG_DIR[ML100K]}/{TRANSE_TEST_METRICS_FILE_NAME}',
...
TRANSE_CFG_FILE_PATH = {
    ML100K: f'{CFG_DIR[ML100K]}/{TRANSE_CFG_FILE_NAME}',
...
BEST_TRANSE_CFG_FILE_PATH = {
    ML100K: f'{BEST_CFG_DIR[ML100K]}/{TRANSE_CFG_FILE_NAME}',
...
PATH_PATTERN = {
    ML1M: {
        ...
        10: ((None, USER), (INTERACTION[ML1M], PRODUCT), (WROTE_BY_WRITER, WRITER), (WROTE_BY_WRITER, PRODUCT)),
