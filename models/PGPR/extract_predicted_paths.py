...
'''
def save_user_interactions(folder_path, user2timestamp):
    print("Saving list of users' interaction timestamps of train_set")
    with open(folder_path + "/user2timestamp.csv", 'w+', newline='') as user2timestamp_file:
...
def save_interactions_timestamps(folder_path, interaction2timestamp):
    print("Saving uid pid interaction timestamps of train_set")
    with open(folder_path + "/uid_pid_timestamp.csv", 'w+', newline='') as uid_pid_timestamp_file:
